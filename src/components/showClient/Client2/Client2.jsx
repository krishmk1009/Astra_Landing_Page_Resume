    ...
    <div className='my-10 '>
      ...
      <div className='lg:flex justify-center'>
        ...
        <div className='lg:inline-flex lg:mx-5  lg:my-10 my-5  mx-5 border rounded py-5 bg-white '>
          <div>
            <img height={"40px"} width={"230px"} className=' px-10   h-12 mx-auto' src='https://cdn.shortpixel.ai/spai/w_209+q_lossless+ret_img/wpastra.com/wp-content/uploads/2021/12/wp-logo.png'
        ...
        <div className='lg:inline-flex lg:mx-5 mx-5  lg:my-10  border rounded py-5 bg-white '>
          <div>
            <img height={"40px"} width={"230px"} className=' px-10  h-12 mx-auto' src='https://cdn.shortpixel.ai/spai/w_169+q_lossless+ret_img/wpastra.com/wp-content/uploads/2020/11/trust-pilot.png'
